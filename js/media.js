/** URLs de mídia no Cloudinary — vídeos 720p pré-encodados */
const CLOUD = "https://res.cloudinary.com/dcc2fweye";

const MEDIA = {
  fachada: `${CLOUD}/image/upload/f_auto,q_auto,w_1600/la-custom/site/fachada`,
  ...
  videos: {
    entrada: `${CLOUD}/video/upload/la-custom/site/entrada.mp4`,
    boxes: `${CLOUD}/video/upload/la-custom/site/boxes.mp4`,
